...
const ChatWrapper = ({fileId}: ChatWrapperProps) => {
    ...
    if(isLoading) return (
        <div className="relative min-h-full bg-zinc-50 flex divide-y divide-zinc-200 flex-col justify-between items-center gap-2">
            ...
            <div className="flex-1 flex justify-center items-center flex-col mb-28">
                <div className="flex flex-col items-center gap-2">
                    ...
                    <Link href='/dashboard' className={buttonVariants({variant:'secondary', className: 'mt-4'})}>
                        <ChevronLeft className="h-3 w-3 mr-1.50"/>
                        Back
                    </Link>
                </div>
            </div>
    ...
    return <div className="relative min-h-full bg-zinc-50 divide-y flex divide-zinc-200 felx-col justify-between gap-2">
