    ...
    <>
       <MaxWidthWrapper className={"mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center"}>
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Quill allows you to have conversationds with any PDF document. Simply upload your file start asking questions right away.
        </p>
      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Chatting to your PDF files never been easier than with Quill.
            </p>
          </div>
        </div>
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1">
              <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-4 md:pt-4">
          ...
          <li className="md:flex-1">   
              <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-4 md:pt-4">
                  ...
                  <span className="text-xl font-semibold">Stop asking questions</span>
                  <span className="mt-2 text-zinc-700">
                   It&apos;s that simple. Try Out Quill today - it really takes less then a minute.
                  </span>
              </div>
          </li>   
        </ol>
